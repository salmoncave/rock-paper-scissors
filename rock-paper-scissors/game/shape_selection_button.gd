...
@onready var hover_gpu_particles_2d: GPUParticles2D = %HoverGPUParticles2D
@onready var selection_trail_gpu_particles_2d: GPUParticles2D = %SelectionTrailGPUParticles2D


func _ready() -> void:
	_create_selection_button_for_shape(shape)
